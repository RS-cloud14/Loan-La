...
const translations: Record<Language, Translations> = {
  en: {
    ...
    headline3Title: 'Need Loan Guidance? Online Application Agent.',
    ...
    headline4Title: "Don't Know Where to Apply? Compare 11+ Licensed Banks.",
