...
const translations: Record<Language, Translations> = {
  en: {
    ...
    partnershipNotice: '💡 How it works: Loan - La acts as your online financial assistant and smart matcher. We analyze your real cashflow and income profile to pre-screen and help you apply directly to suitable Bank Negara Malaysia licensed digital banks and regulated lenders.',
  ...
  bm: {
    ...
    partnershipNotice: '💡 Cara berfungsi: Loan - La bertindak sebagai pembantu kewangan pintar dan pemadan institusi anda. Kami menganalisis aliran tunai sebenar anda untuk membuat pra-saringan dan membantu anda memohon terus kepada bank digital berlesen Bank Negara Malaysia dan institusi terkawal.',
