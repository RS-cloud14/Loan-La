...
const translations: Record<Language, Translations> = {
  en: {
    ...
    headline3Title: 'Need Alternative Financing? Get Guided Pre-Check.',
    headline3Sub: 'We analyze your verified cashflow and help you prepare a solid application for licensed banks and micro-lenders.',
    ...
    partnershipNotice: 'ℹ️ How Loan - La Works: Loan - La is an independent credit analytics and pre-screening platform. We do not issue loans directly. We help borrowers verify alternative cashflow, identify high-probability bank matches, and apply directly to licensed financial institutions with a certified Credit Passport.',
    ...
    situation1Desc: 'Upload bank or gig statements. We audit your cashflow and calculate your safe DSR limit without payslips.',
    situation1Btn: 'Check Income Score →',
  ...
  bm: {
    ...
    headline3Title: 'Perlu Pembiayaan Alternatif? Dapatkan Pra-Semakan Berpandu.',
    headline3Sub: 'Kami menganalisis aliran tunai sebenar anda dan membantu menyediakan permohonan lengkap untuk bank berlesen.',
    ...
    partnershipNotice: 'ℹ️ Cara Loan - La Berfungsi: Loan - La ialah platform analitik kredit dan pra-saringan bebas. Kami TIDAK mengeluarkan pinjaman secara langsung. Kami membantu pemohon mengesahkan aliran tunai, memadankan bank berlesen yang sesuai, dan memohon terus ke portal rasmi institusi kewangan menggunakan Pasport Kredit yang disahkan.',
    ...
    situation1Desc: 'Muat naik penyata bank atau aplikasi gig. Kami mengira had DSR selamat anda tanpa memerlukan slip gaji.',
    situation1Btn: 'Semak Skor Pendapatan →',
