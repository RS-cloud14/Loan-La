...
const translations: Record<Language, Translations> = {
  en: {
    ...
    partnershipNotice: '💡 How it works: Loan - La pre-screens your income and cashflow to match you with suitable lenders before you apply. All loan applications and payouts are handled directly by Bank Negara Malaysia licensed digital banks and regulated institutions.',
  ...
  bm: {
    ...
    partnershipNotice: '💡 Cara berfungsi: Loan - La membuat pra-saringan pendapatan dan aliran tunai untuk memadankan anda dengan bank yang sesuai sebelum memohon. Semua permohonan dan pengeluaran pinjaman dikendalikan terus oleh bank digital dan institusi berlesen Bank Negara Malaysia.',
